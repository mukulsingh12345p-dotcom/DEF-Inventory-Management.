              ...
              <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div>
                   ...
                   <div className="grid grid-cols-2 gap-3">
                     <label className={`cursor-pointer border rounded-lg p-3 flex items-center justify-center gap-2 transition-all ${branchRole === UserRole.ACCOUNTANT ? 'bg-brand-50 border-brand-200 text-brand-700' : 'hover:bg-gray-50 border-gray-200'}`}>
                        <input 
                          type="radio" 
                          name="role" 
                          ...
                          className="hidden"
                        />
                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${branchRole === UserRole.ACCOUNTANT ? 'border-brand-600' : 'border-gray-300'}`}>
                            {branchRole === UserRole.ACCOUNTANT && <div className="w-2 h-2 rounded-full bg-brand-600" />}
                        </div>
                        <span className="text-sm font-medium">Accountant</span>
                     </label>

                     <label className={`cursor-pointer border rounded-lg p-3 flex items-center justify-center gap-2 transition-all ${branchRole === UserRole.USER ? 'bg-brand-50 border-brand-200 text-brand-700' : 'hover:bg-gray-50 border-gray-200'}`}>
                        <input 
                          type="radio" 
                          name="role" 
                          ...
                          className="hidden"
                        />
                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${branchRole === UserRole.USER ? 'border-brand-600' : 'border-gray-300'}`}>
                            {branchRole === UserRole.USER && <div className="w-2 h-2 rounded-full bg-brand-600" />}
                        </div>
