...
export const Dashboard: React.FC = () => {
  ...
  // NOTE: For HO Holistic view, we MUST filter out the HO_STORE_ID data as it is independent.
  ...
  const handlePasswordChange = () => {
    ...
    updatePassword(adminSchoolId, adminRole, newPass);
    alert(`Password for ${adminSchoolId} ${adminRole} updated successfully!`);
    setNewPass('');
  };
                        ...
                        <form onSubmit={handleAddEmployee} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                            <div className="col-span-1">
                                ...
                                {isHO ? (
                                    ...
                                    <input 
                                        type="text" 
                                        className="w-full rounded-md border-gray-300 shadow-sm p-2 border bg-gray-100 text-gray-500"
                            ...
                            <div className="col-span-1">
                                <button type="submit" className="w-full bg-brand-600 text-white py-2 rounded-md hover:bg-brand-700">
                                    Add Employee
                                </button>
                            </div>
                        </form>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4 mt-2">
                                <label className="flex items-center gap-2">
                                    <input type="radio" checked={adminRole === UserRole.ACCOUNTANT} onChange={() => setAdminRole(UserRole.ACCOUNTANT)} /> Accountant
                                </label>
                            </div>
                        </div>
                ...
                <div className="p-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input 
                                type="text" 
                                className="pl-10 w-full rounded-md border-gray-300 shadow-sm p-2 border"
                                placeholder="Enter new password"
