          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input 
                        type="text" 
                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm pl-10 p-2 border"
                      ...
                      <div className="absolute z-10 w-full bg-white border border-gray-200 rounded-md shadow-lg mt-1 max-h-48 overflow-auto">
                          {filteredEmployees.length === 0 ? (
                              ...
                              filteredEmployees.map(emp => (
                                  <div 
                                      key={emp.id}
                                      className="px-4 py-2 hover:bg-brand-50 cursor-pointer text-sm text-gray-700 flex justify-between"
                                      onClick={() => {
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                    ...
                    <div className="relative w-full md:w-64">
                        ...
                        <input 
                            type="text" 
                            className="pl-9 w-full rounded-md border-gray-300 shadow-sm p-2 border"
